...
@bot.command()
@commands.has_any_role("Commissioner", "Moderator", "League Admin")
...
async def _post_fta_position_adp(ctx, forum: discord.ForumChannel, position_short: str, position_long: str):
    ...
    thread = (await forum.create_thread(name=thread_title, content=ADP_GLOSSARY))[0]
